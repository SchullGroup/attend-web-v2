...
export default function HackathonPage() {
  ...
  // Same progression as the challenge detail page (RSVP to Apply ΓåÆ Apply now ΓåÆ
  // View Application) ΓÇö looked up per card by eventId rather than fetched per card.
            ...
            <li key={c.id} className="overflow-hidden rounded-2xl border border-border bg-white shadow-sm flex flex-col">
              ...
              <div className="grid gap-4 p-5 md:grid-cols-[1fr_auto] md:items-center">
                ...
                {(() => {
                  ...
                  // everything; otherwise RSVP to Apply ΓåÆ Apply now ΓåÆ View Application,
